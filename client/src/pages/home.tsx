    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Sistema Completo de Casting</h3>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-xl font-bold text-blue-900 mb-4">Portal Interativo</h4>
              <p className="text-gray-600 mb-4">
                Sistema completo para inscrição de talentos infantis do SBT. Realize seu cadastro online, 
                agende sua participação no casting e receba seus cartões de embarque digitais.
              </p>
              <ul className="text-gray-600 space-y-2">
                <li>• Chat bot inteligente da Rebeca para organização de viagem</li>
                <li>• Sistema de pagamento PIX integrado</li>
                <li>• Geração automática de documentos de viagem</li>
                <li>• Agendamento de datas disponíveis</li>
              </ul>
            </div>
            <div>
              <h4 className="text-xl font-bold text-blue-900 mb-4">Como Participar</h4>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Preencha os dados do responsável e candidato</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center mr-3 text-sm font-bold">2</div>
                  <div>
                    <p className="font-medium">Escolha sua data</p>
                    <p className="text-gray-600 text-sm">Selecione um sábado disponível para o teste</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center mr-3 text-sm font-bold">3</div>
                  <div>
                    <p className="font-medium">Organize sua viagem</p>
                    <p className="text-gray-600 text-sm">Use o chat bot para definir transporte e hospedagem</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center">
            ...
            <Link href="/cartao-preview" className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors font-medium text-center">
      ...
      <footer className="bg-blue-900 text-white py-12 mt-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-300 text-sm mt-4">Desenvolvido especialmente para o SBT</p>
        </div>
      </footer>
    </div>
  );
